...
public class SortedStorageNonSet<T extends Comparable> implements Comparable, SortedStorageInterface<T>  {
    ...
    int nullCounter;
    public SortedStorageNonSet(boolean b){
        linkedList = null;
    }
    ...
    /**
     * This method is an iterator for the SortedStorageNonSet class.
    ...
    /**
     * This is private class which contains all the abstract method of the
     * iterator interface.
     * @param <T>
     */
    private class myIterator<T> implements Iterator<T>{
        ...
        /**
         * This method checks if there is a next element present in the
         * collection.
        ...
        /**
         * This method displays the next element in the collection.
         * @return Returns the value of the next element present.
         */
        @Override
        public T next() {
        ...
        /**
         * This is a method of the iterator interface.
         */
        @Override
        public void remove(){
        }
