...
public class SortedStorage<T extends Comparable> implements Comparable, SortedStorageInterface<T> {
    ...
    public synchronized boolean add(T x){
        ...
        System.out.println("Adding has started");
    ...
    public boolean includesNull(){
        if (linkedList != null && linkedList.value == null){
            ...
            System.out.println("Null Not Present");
            return false;
        }
        System.out.println("Null Not Present");
        return false;
    ...
    private class myIterator<T> implements Iterator<T>{
        ...
        public T next() {
            ...
            try {
                ...
                linkedList = linkedList.nextElement;
                System.out.println("Element present : " + next_element.value);
                return (T) next_element.value;
            } catch (NullPointerException e){
                return (T) "Storage is empty";
            }
        }
